...
public class RequestMapper {
    ...
    public static RequestStatusUpdateApprove toEventRequestStatusUpdateResult(List<Request> confirmed, List<Request> rejected) {
        ...
        return new RequestStatusUpdateApprove(confirmedRequests, rejectedRequests);
    }
}
